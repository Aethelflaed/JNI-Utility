...
Signature* JVM::method_Object_notify = new Signature("notify", "()V");
Signature* JVM::method_Object_notifyAll = new Signature("notifyAll", "()V");
Signature* JVM::method_Object_wait = new Signature("wait", "()V");
Signature* JVM::method_Object_wait_L = new Signature("wait", "(L)V");
Signature* JVM::method_Object_wait_LI = new Signature("wait", "(LI)V");
